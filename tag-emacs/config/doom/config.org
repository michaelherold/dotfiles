...
** TODO File a bug with Doom about this
<2021-01-10 Sun>
...
** TODO Add the ability to toggle to a light theme
:PROPERTIES:
...
** TODO Consider adding a ~fontconfig~ tangle here
:PROPERTIES:
:CREATED: <2021-01-09 Sat>
:END:
...
** TODO Consider submitting a patch to Doom to infer your dictionary when unset
:PROPERTIES:
:CREATED:  <2021-01-09 Sat>
:END:
...
When showing tasks for the day, I want to make sure I'm including notes from my dailies, so this adds advice to the appropriate Doom hook for working with ~org-agenda-files~.

#+begin_src elisp
(defun +mjh-org-init-agenda-h ()
  (setq org-agenda-files (list "~/org/" "~/org/roam/daily/")))
