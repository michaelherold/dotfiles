...
(setq mjh-ruby-on-rails-packages
  '(
    feature-mode
    projectile-rails
    which-key
...
(defun mjh-ruby-on-rails/init-projectile-rails ()
...
(defun mjh-ruby-on-rails/init-feature-mode ()
  "Initialize Cucumber feature mode"
  (use-package feature-mode
    :mode (("\\.feature\\'" . feature-mode))))

(defun mjh-ruby-on-rails/post-init-which-key ()
